...
//   var login_page = device.sendAai({ query: "T:*登录后，体验完整功能*", action: "getBounds" });
//   if(login_page){
//     device.sendAai({ query: "C:.Button&&R:.ju8", action: "click" });
//   }
// }
...
//                   printf("title 1 : "+title1)
//                var obj = UiElement.findObjects(device,"C:.TextView&&R:.title&&CC:0");
//                if (obj != null) {
//                    var output = obj.getText();
//                    if (output.success()) {
//                          print('All Text: ' + output.values());
//                    } else {
//                          print('Error: ' + output.lastError());
//                    }
//                 } else {
